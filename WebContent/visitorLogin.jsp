              ...
              <div class="container">
                <div class="wrapper">
                  <article class="grid_8">
					...
					<fieldset>
					 <form id="contact-form" method="post" action="/Hybrid_car/visitor_login_service" method="post" name=login>
					 <table width="900" border="1">
					 <tr>
    					<td width="300" height="70">&nbsp;</td>
						<td ></td>
 					   <td>  <h3 class="p1">Visitor Login</h3></td>
				  </tr>
  					<tr>
				...
				<tr>
				    <td>&nbsp;</td>
					<td>&nbsp;</td>
					<td> <font style="background-color: yellow;">
				...
				<tr>
					<td></td>
					<td></td>
					<td><a href="register.jsp"><h4>New User registration</h4></a></td>
				</tr>
</table>
</form>
      </fieldset>     
