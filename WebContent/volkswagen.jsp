...
<p><form method="post" action="/Hybrid_car/images.jsp" >     
          <input type="submit" name="Audi" value="volkswagen images">
          </form>
          </div>
    <!--==============================footer=================================-->
   <footer>
