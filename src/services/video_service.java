...
@WebServlet("/video_service")
public class video_service extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			int rs=st.executeUpdate("insert into car_videos(car_comp_name,car_type,path) values('"+ccname+"','"+ctype+"','"+file+"')");
		    if(rs!=0)
		    {
		    	out.print("Ok");
		    	s.setAttribute("msg","New Car video Saved Successfully.");
